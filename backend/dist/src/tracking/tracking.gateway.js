...
let TrackingGateway = TrackingGateway_1 = class TrackingGateway {
    ...
    handleLocationUpdate(data, client) {
        const room = `order_room_${data.orderId}`;
        this.logger.log(`Rider ${data.riderId} location: [${data.lat}, ${data.lng}] → ${room}`);
    ...
    handleOrderDelivered(data, client) {
        const room = `order_room_${data.orderId}`;
...
__decorate([
    (0, websockets_1.SubscribeMessage)('orderDelivered'),
    __param(0, (0, websockets_1.MessageBody)()),
    __param(1, (0, websockets_1.ConnectedSocket)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, socket_io_1.Socket]),
    __metadata("design:returntype", void 0)
], TrackingGateway.prototype, "handleOrderDelivered", null);
