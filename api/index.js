...
async function bootstrap() {
  ...
  app.enableCors({ origin: [process.env.FRONTEND_URL, 'https://grocer-omega.vercel.app', 'http://localhost:5173', /\.vercel\.app$/].filter(Boolean) as (string | RegExp)[], credentials: true });
